...
import co.changemelody.soundfile.SoundFile;


public class SelectMelodyActivity    extends ListActivity   implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void confirmDelete() {
        ...
        new AlertDialog.Builder(SelectMelodyActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(
    ...
    private void onRecord() {
        try {
            ...
            Log.e("ChangeMelody", "Couldn't start editor");
        }
    }

    private void onMelodyClicked() {
        Cursor c = mAdapter.getCursor();
        try {
            Intent intent = new Intent(SelectMelodyActivity.this, MainActivity.class);
            intent.putExtra("uriName",getUri().toString() );
